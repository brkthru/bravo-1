    ...
    <div className="min-h-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-2">Coming Soon</p>
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            Get ready for powerful analytics that transform your media buying decisions with
        ...
        <div className="mt-20 text-center">
          ...
          <p className="mt-6 text-sm text-gray-500 dark:text-gray-400">Expected launch: Q1 2025</p>
        </div>
