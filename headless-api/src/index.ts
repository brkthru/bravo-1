...
// API v0 routes (current version - pre-release)
const v0Router = express.Router();
v0Router.use('/campaigns', campaignRoutes);
v0Router.use('/users', userRoutes);
v0Router.use('/etl', etlRoutes);
v0Router.use('/proposals', proposalsRoutes);
v0Router.use('/execution-plans', executionPlansRoutes);
v0Router.use('/insertion-orders', insertionOrdersRoutes);
