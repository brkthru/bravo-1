  ...
  const steps = [
    {
      ...
      description: 'Extracting data from MongoDB...'
    },
    {
      name: 'Transform',
    ...
    },
    {
      name: 'Load',
      script: 'load-data.ts',
      description: 'Loading data back to MongoDB...'
    }
  ];
